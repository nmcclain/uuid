...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.uuid.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".uuid" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".uuid")
	}
